...
GLUI_Spinner    *light0_spinner, *light1_spinner,*mat_spinner;
...
#define MAT_ENABLED_ID 	     270
#define MAT_INTENSITY    	 280
...
//GLfloat light0_shine= 20.0;

GLfloat light1_ambient[] =  {0.1f, 0.1f, 0.3f, 1.0f};
GLfloat light1_diffuse[] =  {.9f, .6f, 0.0f, 1.0f};
GLfloat light1_position[] = {-1.0f, -1.0f, 1.0f, 0.0f};
//GLfloat light1_shine=30.0;
...
void control_cb( int control )
{
  ...
  else if(control == MAT_INTENSITY)
  {
  	float u[] = {mat_specular[0],mat_specular[1],
  		mat_specular[2],mat_specular[3]};
  	u[0] *=mat_intensity;
  	u[1] *=mat_intensity;
  	u[2] *=mat_intensity;
...
int main(int argc, char* argv[])
{
  ...
  main_window = glutCreateWindow( "Illuminating Paradigm of Shadow Rendering" );
  ...
  obj_panel = new GLUI_Rollout(glui, "Object Properties", false );
 ...
 //  GLUI_Spinner *spinner1 = new GLUI_Spinner(obj_panel,"param1:",&scale);
 //  spinner1->set_int_limits(1,10);
 //  spinner1->set_alignment(GLUI_ALIGN_RIGHT);


 // GLUI_Spinner *spinner2 = new GLUI_Spinner(obj_panel,"param1:",&scale);
 //  spinner2->set_int_limits(1,10);
 //  spinner2->set_alignment(GLUI_ALIGN_RIGHT);

 // GLUI_Spinner *spinner3 = new GLUI_Spinner(obj_panel,"param1:",&scale);
 //  spinner3->set_int_limits(1,10);
...
// glui3 = GLUI_Master.create_glui_subwindow( main_window,
// 					    GLUI_SUBWINDOW_LEFT );

// /*******Add some controls for material******/
// GLUI_Rollout *roll_material = new GLUI_Rollout(glui3,"Materials",true);

// GLUI_Panel *mat0 = new GLUI_Panel( roll_material, "Material" );
//   //GLUI_Panel *light1 = new GLUI_Panel( roll_lights, "Light 2" );

//   new GLUI_Checkbox( mat0, "Enabled", &mat_enabled,
//                      MAT_ENABLED_ID, control_cb );

//   mat_spinner = new GLUI_Spinner( mat0, "Intensity:",
//                       &mat_intensity,	 MAT_INTENSITY,
//                       control_cb );
//   mat_spinner->set_float_limits( 0.0, 1.0 );
//   GLUI_Scrollbar *sb1;
//   sb1 = new GLUI_Scrollbar( mat0, "Red",GLUI_SCROLL_HORIZONTAL,
//                            &mat_specular[0],MAT_INTENSITY,control_cb);
//   sb1->set_float_limits(0,1);
//   sb1 = new GLUI_Scrollbar( mat0, "Green",GLUI_SCROLL_HORIZONTAL,
//                            &mat_specular[1],MAT_INTENSITY,control_cb);
//   sb1->set_float_limits(0,1);
//   sb1 = new GLUI_Scrollbar( mat0, "Blue",GLUI_SCROLL_HORIZONTAL,
//                            &mat_specular[2],MAT_INTENSITY,control_cb);
//   sb1->set_float_limits(0,1);
